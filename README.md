...
RV32IM core with register renaming, dynamic scheduling,
an LSQ/ROB, and precise in-order retirement.
...
FPGA Tetris engine with BRAM-backed board state,
HDMI output, and ESP32 Bluetooth controls.
...
system calls, scheduling, drivers, and a filesystem.
...
Bit-sliced RISC-V datapath with custom standard cells
and automated physical design in Cadence Innovus.
